...
import sty from "./PlasmicReviewCard.module.css"; // plasmic-import: wfkYQsFF-B06vO/css
  ...
  return (
    true ? (
      ...
      >
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__q7OhE)}
          ...
          src={{
            src: "/plasmic/article_1_component_package/images/sidereview1Png.png",
            fullWidth: 119,
            fullHeight: 119,
        ...
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__s5Bh1)}
